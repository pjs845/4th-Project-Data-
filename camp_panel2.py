...
for x in a:
    ...
    if info == None:
        ...
        if detail1_sub == None and detail3_sub == None and detail4_sub == None:
            ...
            dict = {detail2.text.strip():detail2_sub.text.strip()}
            ...
            dict = {detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip())}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)
            ...
            print(detail2.text.strip(), re.sub(r"\s", " ", detail2_sub.text.strip()))
            print(detail3.text.strip(), re.sub(r"\s", " ", detail3_sub.text.strip()))
            dict = {detail1.text.strip():re.sub(r"\s", " ", detail1_sub.text.strip()), detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip())}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)
            ...
            dict = {detail1.text.strip():re.sub(r"\s", " ", detail1_sub.text.strip()), detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip()), detail4.text.strip():detail4_sub.text.strip()}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)
            ...
            dict = {detail1.text.strip():re.sub(r"\s", " ", detail1_sub.text.strip()), detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip()), detail4.text.strip():detail4_sub.text.strip(), detail5.text.strip():detail5_sub.text.strip()}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)
            ...
            dict = {detail1.text.strip():re.sub(r"\s", " ", detail1_sub.text.strip()), detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip()), detail4.text.strip():detail4_sub.text.strip(), detail5.text.strip():detail5_sub.text.strip(), detail6.text.strip():detail6_sub.text.strip()}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)
            ...
            dict = {detail1.text.strip():re.sub(r"\s", " ", detail1_sub.text.strip()), detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip()), detail4.text.strip():detail4_sub.text.strip(), detail5.text.strip():detail5_sub.text.strip(), detail6.text.strip():detail6_sub.text.strip(), detail7.text.strip():detail7_sub.text.strip()}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)
            ...
            dict = {detail1.text.strip():re.sub(r"\s", " ", detail1_sub.text.strip()), detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip()), detail4.text.strip():detail4_sub.text.strip(), detail5.text.strip():detail5_sub.text.strip(), detail6.text.strip():detail6_sub.text.strip(), detail7.text.strip():detail7_sub.text.strip(), detail8.text.strip():re.sub(r"\s", " ", detail8_sub.text.strip())}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)      
        else:
            print( "번호:", x ,"캠프 이름:",camp_name.text.strip())
            print(detail1.text.strip(), re.sub(r"\s", " ", detail1_sub.text.strip()))
            ...
            dict = {detail1.text.strip():re.sub(r"\s", " ", detail1_sub.text.strip()), detail2.text.strip():re.sub(r"\s", " ", detail2_sub.text.strip()), detail3.text.strip():re.sub(r"\s", " ", detail3_sub.text.strip()), detail4.text.strip():detail4_sub.text.strip(), detail5.text.strip():detail5_sub.text.strip(), detail6.text.strip():detail6_sub.text.strip(), detail7.text.strip():detail7_sub.text.strip(), detail8.text.strip():re.sub(r"\s", " ", detail8_sub.text.strip()), detail9.text.strip():detail9_sub.text.strip()}
            col.update_one({"_id":x}, {"$set":dict}, upsert=True)    
