...
#print(bary)
a = plt.bar('names','marks', w, data=df_sorted,color='peru',align='edge', edgecolor='chocolate')
...
plt.ylim(0,800) 
plt.title("[ CAMPGROUND | 지역별 캠핑장 수 ]",loc='right',color='dimgrey',fontsize =14)
for rect in a:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height, '%0.0f' % height, ha='center', va='bottom', size = 8)
plt.show()
